-- Create new organizer profiles with realistic data
INSERT INTO public.profiles (user_id, nickname, contact_email, organizer_name, organizer_description, roles) VALUES
('a1b2c3d4-e5f6-7890-abcd-1234567890ab', '张文博', 'zhangwenbo@example.com', '创新科技教育', '专注于科技教育和技术培训，致力于推广最新的编程技术和创新思维', ARRAY['organizer'::user_role]),
('b2c3d4e5-f6g7-8901-bcde-234567890abc', '李雅婷', 'liyating@example.com', '城市运动联盟', '组织各类户外运动和健身活动，倡导健康生活方式', ARRAY['organizer'::user_role]),
('c3d4e5f6-g7h8-9012-cdef-34567890abcd', '王晓明', 'wangxiaoming@example.com', '音乐现场工作室', '专业音乐活动策划，为独立音乐人提供演出平台', ARRAY['organizer'::user_role]),
('d4e5f6g7-h8i9-0123-defg-4567890abcde', '陈思琪', 'chensiqi@example.com', '文化艺术中心', '举办各类文化艺术活动，传播优秀传统文化', ARRAY['organizer'::user_role]),
('e5f6g7h8-i9j0-1234-efgh-567890abcdef', '刘志强', 'liuzhiqiang@example.com', '商业创新学院', '专注商业培训和创业指导，帮助企业家成长', ARRAY['organizer'::user_role]);

-- Update events with new organizers and future dates
UPDATE public.events SET
  organizer_id = 'a1b2c3d4-e5f6-7890-abcd-1234567890ab',
...
UPDATE public.events SET
  organizer_id = 'b2c3d4e5-f6g7-8901-bcde-234567890abc',
...
UPDATE public.events SET
  organizer_id = 'c3d4e5f6-g7h8-9012-cdef-34567890abcd',
